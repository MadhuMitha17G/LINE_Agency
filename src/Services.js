...
const Services = () => {
  ...
  const handlePointerUp = () => {
    ...
    // Always restart auto-scroll after drag/touch ends
    requestRef.current = requestAnimationFrame(animateScroll);
  };
    ...
    <div className="services-section">
      ...
      {activeCategory && (
        ...
        >
          ...
          <div 
            className="subcards-container marquee"
            ref={scrollContainerRef}
            {...(typeof window !== 'undefined' && window.matchMedia('(max-width: 768px)').matches ? {
              onMouseDown: (e) => {
                const marquee = scrollContainerRef.current;
                marquee.style.animationPlayState = 'paused';
                marquee.isDragging = true;
                marquee.startX = e.pageX - marquee.offsetLeft;
                marquee.scrollLeftStart = marquee.scrollLeft;
              ...
              onMouseMove: (e) => {
                ...
                marquee.scrollLeft = marquee.scrollLeftStart - walk;
              },
              onMouseUp: () => {
                const marquee = scrollContainerRef.current;
              ...
              onTouchStart: (e) => {
                ...
                marquee.style.animationPlayState = 'paused';
                marquee.isDragging = true;
                marquee.startX = e.touches[0].pageX - marquee.offsetLeft;
                marquee.scrollLeftStart = marquee.scrollLeft;
                marquee.classList.add('dragging');
              },
              onTouchMove: (e) => {
